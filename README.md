...
# The Light memory puzzle

A simple application to test your memory. Watch the grid, the colours will randomly go off, and all you need to do is match the pattern when the application prompts you to.
...
- On click pass in the colour and store it. Once done send
- Unit tests
